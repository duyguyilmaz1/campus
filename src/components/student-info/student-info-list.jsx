...
/*row --> her bir öğrenci bilgisini temsil eden bir satırın bilgilerini almak için kullanılır. Bu satır bilgileri, DataTable bileşeninin içinde belirtilen list dizisindeki her bir öğrenci verisi için çağrılır. */
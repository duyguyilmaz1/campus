...
const TeacherList = () => {
  ...
  const loadData = async () => {
    try {
      const resp = await getTeachersByPage(lazyState.page, lazyState.rows);
    ...
    return (
      <div>
        <Button
          ...
          className="me-2"
          onClick={() => handleEdit(row)} //editlenen data merkezi state gonderiliyor --> edit-teacher da merkezi state den cekiyoruz 
        >
          <FaEdit />
        </Button>

...
const EditStudentForm = () => {
    ...
    const initialValues = {
      ...
      //not--> row icinde zaten satirin tum datalari oldug icin direk merkezi state den edit icin tum bilgiler aldik.
      //normalde bunun yerien direk backednen de cekilenilir
    const validationSchema = Yup.object({
      ...
      const formik = useFormik({
        ...
        validationSchema,
        onSubmit,
        enableReinitialize: true //her user degiisinde intialValues a yeni degerler atayabilmek icin 
      });

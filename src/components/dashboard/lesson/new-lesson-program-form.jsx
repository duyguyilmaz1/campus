...
const NewLessonProgramForm = () => {
  ...
  const initialValues = { //buraya BE'teki request classındaki değerleri yazıyoruz: LessonProgramRequest mesela
    day: "",
    educationTermId: "",
    lessonIdList: [], //dizi olcak cunku selectle birlikte birden fazla ders secebilirz --> o yuzden dizi halinde yazdik 
    startTime: "",
    stopTime: "",
  };
  ...
  useEffect(() => { //ilk girişte çalışacak.
    loadLessons();
    loadTerms();
  }, []);
        ...
        <Card.Body>
          ...
          <Form noValidate onSubmit={formik.handleSubmit}>
            <Row xs={1} sm={2} md={3} className="g-3">
              <Col>
                <MultiSelect //bunu PrimeReact kütüphanesinden kopyaladık. 
                  value={formik.values.lessonIdList} //
                  onChange={(e) => //o anda kac tane isaretlediysem onlari veriyor e.value ile..
                    formik.setFieldValue("lessonIdList", e.value)
                  }
                  options={lessons} //multiselct i doldurmak istedigimz seyi yazmaliyiz --> biz derslerle doldurmak istiyoruz 
                  optionLabel="lessonName" //kullanicin gordugu kisim 
                  optionValue="lessonId" //value yani arka plandaki 

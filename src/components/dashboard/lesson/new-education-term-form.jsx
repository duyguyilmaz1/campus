...
const getTermKeys = () => config.educationTerms.map((item) => item.key); //configdeki term in label halini elde ettik dizi halinde -->keylerden olusan bir dizi vercek
...
const NewEducationTermForm = () => {
  ...
  const validationSchema = Yup.object({
    term: Yup.string()
      .required("Required")
      .oneOf(getTermKeys(), "Invalid term"), //oneOf da sadece verilen dizideki elemanlardan biri yazilabilir demek 
              ...
              <Col>
                <FloatingLabel controlId="term" label="Term" className="mb-3">
                  ...
                  >
                    ...
                    {config.educationTerms.map((item) => ( // config deki term in label degerlerini doncek, herdönüşünde bir item verecek

...
const EditManagerForm = () => {
  ...
  const { currentRecord } = useSelector((state) => state.misc); //cuurentRecorda hangi rowdaysa o row daki tum datalari gondermistik, artik editManegerForm kullanici bilgilerine ulasbilir--> bunlar uzerinde degisklik yapabilcek 

  const dispatch = useDispatch();

  const initialValues = { ...currentRecord, password: "", confirmPassword: "" }; //burada editlemek istediğimiz userın tüm bilgileri dolu halde forma gelir.
    // currentRecords un içinde password ve confirmPassword yok cunku zaten BE'den password gelmez. bu sebeple bu ikisini initialValues'e vermeliyiz.
  ...
  const onSubmit = async (values) => {
    ...
    try {
      ...
      swalAlert("Manager was updated", "success");
    } catch (err) {
  ...
  const formik = useFormik({
    ...
    validationSchema,
    onSubmit,
    enableReinitialize: true, // initialValues alanının tekrar tekrar değiştirilebilmesine izin verir
